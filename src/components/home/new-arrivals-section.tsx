...
export function NewArrivalsSection({ products }: NewArrivalsSectionProps) {
  ...
  return (
    <section
      ...
      className="relative w-full py-16 sm:py-24 bg-muted/20 border-b border-border/60"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-10 sm:mb-12 gap-4">
          <div>
            ...
            <p className="text-xs sm:text-sm text-muted-foreground font-light mt-2 max-w-xl leading-relaxed">
              Explore our latest seasonal silhouettes, fresh hand-embellished pieces, and
              modern festive wear ready for immediate worldwide dispatch.
            </p>
          </div>
        ...
        <div className="mt-12 sm:mt-16 text-center">
          <Link
            href="/shop"
            className="inline-flex items-center justify-center gap-3 px-8 py-3.5 bg-primary text-white hover:bg-primary/95 text-xs uppercase tracking-[0.22em] font-medium transition-all duration-300 shadow-xs"
          >
